      ...
      <div className="card animate-fade-in" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: '0.5rem' }}>
            Únete a Bet<span className="gradient-text">IQ</span>
          </h1>
          <p style={{ color: 'var(--foreground-muted)', fontSize: '0.9rem' }}>
            Tu bankroll te espera con $1,000 iniciales
          </p>
        </div>
        ...
        {success ? (
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            >
              {loading ? 'Preparando todo...' : <><UserPlus size={18} /> Crear Cuenta</>}
            </button>
          </form>
        )}
        ...
        {!success && (
          <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.9rem' }}>
            <span style={{ color: 'var(--foreground-muted)' }}>¿Ya tienes cuenta? </span>
